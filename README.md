...
![CI/CD Architecture](img/architecture.png)
...
pipeline {
    ...
    stages {
        stage('pull') {
            steps {
                git branch: 'main', url: 'https://github.com/Prathmesh9921/Node.js-Application-Deployment-using-Jenkins-Docker.git'
            }
        }
...
4. Choose:
   ...
   - Git
   - Repository URL:
     https://github.com/Prathmesh9921/Node.js-Application-Deployment-using-Jenkins-Docker.git
   - Branch → */main
   - Script Path → jenkinsfile

### **Save.**

![img](/img/git%20add.png)
